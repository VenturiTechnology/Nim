...
function nsuFindChar(s_989857438, sub_989857439, start_989857440, last_989857441) {
  ...
  BeforeRet: {
    ...
    Label2: {
      ...
      F.line = 1917;
      colontmp__973078643 = start_989857440;
      F.line = 90;
      var res_973078644 = colontmp__973078643;
      Label3: {
        F.line = 91;
          Label4: while (true) {
          if (!(res_973078644 <= last_989857443)) break Label4;
            F.line = 1931;
            iHEX60gensym178_989857457 = res_973078644;
...
function nsuInitSkipTable(a_989857363, sub_989857364) {
  ...
  framePtr = F;
    ...
    Label1: {
      ...
      F.line = 1849;
      colontmp__973078649 = subInt(m_989857365, 1);
      F.line = 119;
      var i_973078650 = 0;
      Label2: {
        F.line = 120;
...
function HEX3Aanonymous_973078598(r_973078599) {
  ...
  BeforeRet: {
    ...
    F.line = 249;
    failedAssertImpl_268435532(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/asyncjs_examples_2.nim(18, 5) `reason == nil` "));
    }
    ...
    if (!(!((reason_973078561 == null)))) {
    F.line = 249;
    failedAssertImpl_268435532(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/asyncjs_examples_2.nim(20, 5) `reason != nil` "));
    }
    
    if (!(contains_989857617(cstrToNimstr(reason_973078561.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 249;
    failedAssertImpl_268435532(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/asyncjs_examples_2.nim(21, 5) `\"foobar: 7\" in $reason.message` "));
    }
